...
class RedManager {
  ...
  async init(express) {
    ...
    redSettings.editorTheme.palette.catalogues.push("http://localhost:" + process.env.LINTO_STACK_BLS_HTTP_PORT +
      process.env.LINTO_STACK_BLS_SERVICE_API_PATH + '/catalogue/read')
